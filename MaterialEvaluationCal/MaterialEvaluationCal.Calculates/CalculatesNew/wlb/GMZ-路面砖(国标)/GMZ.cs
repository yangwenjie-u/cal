                ...
                else
                {
                    ...
                    if (sItem["GGXH"] == "小于等于4")   //抗压
                    {
                        ...
                        if (jcxm.Contains("、抗压强度、") || jcxm.Contains("、抗折强度、"))
                        {
                            ...
                            if (mMj1 != 0)
                                sItem["KYQD1"] = Round(1000 * GetSafeDouble(sItem["KYHZ1"]) / mMj1, 1).ToString();
                            else
                                sItem["KYQD1"] = "0";
                            if (mMj2 != 0)
                                sItem["KYQD2"] = Round(1000 * GetSafeDouble(sItem["KYHZ2"]) / (mMj2), 1).ToString();
                            else
                                sItem["KYQD2"] = "0";
                            if (mMj3 != 0)
                                sItem["KYQD3"] = Round(1000 * GetSafeDouble(sItem["KYHZ3"]) / (mMj3), 1).ToString();
                            else
                                sItem["KYQD3"] = "0";
                            if (mMj4 != 0)
                                sItem["KYQD4"] = Round(1000 * GetSafeDouble(sItem["KYHZ4"]) / (mMj4), 1).ToString();
                            else
                                sItem["KYQD4"] = "0";
                            if (mMj5 != 0)
                                sItem["KYQD5"] = Round(1000 * GetSafeDouble(sItem["KYHZ5"]) / (mMj5), 1).ToString();
                            else
                                sItem["KYQD5"] = "0";
                            if (mMj6 != 0)
                                sItem["KYQD6"] = Round(1000 * GetSafeDouble(sItem["KYHZ6"]) / (mMj6), 1).ToString();
                            else
                                sItem["KYQD6"] = "0";
                            if (mMj7 != 0)
                                sItem["KYQD7"] = Round(1000 * GetSafeDouble(sItem["KYHZ7"]) / (mMj7), 1).ToString();
                            else
                                sItem["KYQD7"] = "0";
                            if (mMj8 != 0)
                                sItem["KYQD8"] = Round(1000 * GetSafeDouble(sItem["KYHZ8"]) / (mMj8), 1).ToString();
                            else
                                sItem["KYQD8"] = "0";
                            if (mMj9 != 0)
                                sItem["KYQD9"] = Round(1000 * GetSafeDouble(sItem["KYHZ9"]) / (mMj9), 1).ToString();
                            else
                                sItem["KYQD9"] = "0";
                            if (mMj10 != 0)
                                sItem["KYQD10"] = Round(1000 * GetSafeDouble(sItem["KYHZ10"]) / (mMj10), 1).ToString();
                            else
                                sItem["KYQD10"] = "0";
                        ...
                        if (jcxm.Contains("、抗冻性、"))
                        {
                            ...
                            {
                                sItem["DHKYQD1"] = Round(1000 * GetSafeDouble(sItem["DHKYHZ1"]) / (mMj1), 1).ToString();
                                sItem["DHKYQD2"] = Round(1000 * GetSafeDouble(sItem["DHKYHZ2"]) / (mMj2), 1).ToString();
                                sItem["DHKYQD3"] = Round(1000 * GetSafeDouble(sItem["DHKYHZ3"]) / (mMj3), 1).ToString();
                                sItem["DHKYQD4"] = Round(1000 * GetSafeDouble(sItem["DHKYHZ4"]) / (mMj4), 1).ToString();
                                sItem["DHKYQD5"] = Round(1000 * GetSafeDouble(sItem["DHKYHZ5"]) / (mMj5), 1).ToString();
                            }
                            else
                            {
                                sItem["DHKYQD1"] = "0";
                            ...
                            if (mDqky>0)
                            {
                                sItem["QDSSL"] = Round((mDqky - GetSafeDouble(sItem["DHKYPJ"])) / mDqky * 100, 1).ToString();
                            }
                            else
                            {
                                sItem["QDSSL"] = "0";
                    ...
                    else //抗折
                    {
                        ...
                        if (jcxm.Contains("、抗压强度、") || jcxm.Contains("、抗折强度、"))
                        {
                            ...
                            sItem["KZHZ6"] = Round(GetSafeDouble(sItem["KZHZ6"]), 2).ToString();
                            sItem["KZHZ7"] = Round(GetSafeDouble(sItem["KZHZ7"]), 2).ToString();
                            sItem["KZHZ8"] = Round(GetSafeDouble(sItem["KZHZ8"]), 2).ToString();
                            sItem["KZHZ9"] = Round(GetSafeDouble(sItem["KZHZ9"]), 2).ToString();
                            sItem["KZHZ10"] = Round(GetSafeDouble(sItem["KZHZ10"]), 2).ToString();
                            ...
                            sItem["KZQD6"] = Round((3000 * GetSafeDouble(sItem["KZHZ6"]) * GetSafeDouble(sItem["ZZJL"])) / (2 * GetSafeDouble(sItem["KD6"]) * GetSafeDouble(sItem["HD6"]) * GetSafeDouble(sItem["HD6"])), 2).ToString();
                            sItem["KZQD7"] = Round((3000 * GetSafeDouble(sItem["KZHZ7"]) * GetSafeDouble(sItem["ZZJL"])) / (2 * GetSafeDouble(sItem["KD7"]) * GetSafeDouble(sItem["HD7"]) * GetSafeDouble(sItem["HD7"])), 2).ToString();
                            sItem["KZQD8"] = Round((3000 * GetSafeDouble(sItem["KZHZ8"]) * GetSafeDouble(sItem["ZZJL"])) / (2 * GetSafeDouble(sItem["KD8"]) * GetSafeDouble(sItem["HD8"]) * GetSafeDouble(sItem["HD8"])), 2).ToString();
                            sItem["KZQD9"] = Round((3000 * GetSafeDouble(sItem["KZHZ9"]) * GetSafeDouble(sItem["ZZJL"])) / (2 * GetSafeDouble(sItem["KD9"]) * GetSafeDouble(sItem["HD9"]) * GetSafeDouble(sItem["HD9"])), 2).ToString();
                            sItem["KZQD10"] = Round((3000 * GetSafeDouble(sItem["KZHZ10"]) * GetSafeDouble(sItem["ZZJL"])) / (2 * GetSafeDouble(sItem["KD10"]) * GetSafeDouble(sItem["HD10"]) * GetSafeDouble(sItem["HD10"])), 2).ToString();
