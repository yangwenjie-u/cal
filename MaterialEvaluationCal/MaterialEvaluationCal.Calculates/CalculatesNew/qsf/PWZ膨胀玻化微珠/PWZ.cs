...
namespace Calculates
{
    public class PWZ:BaseMethods
    {
        public void Calc()
        {
            ...
            var extraDJ = dataExtra["BZ_PWZ_DJ"];
            var data = retData;

            var SItem = data["S_PWZ"];
            var MItem = data["M_PWZ"];
            var jcxmBhg = "";
            var jcxmCur = "";
            ...
            foreach (var sItem in SItem)
            {
                ...
                var extraFieldsDj = extraDJ.FirstOrDefault(u => u["MC"] == sItem["CPMC"].Trim() && u["LB"] == sItem["LB"].Trim());
