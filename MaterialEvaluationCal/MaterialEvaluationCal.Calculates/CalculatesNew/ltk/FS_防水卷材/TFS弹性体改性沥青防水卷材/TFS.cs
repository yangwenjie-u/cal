...
namespace Calculates
{
    public class TFS : BaseMethods
    {
        public void Calc()
        {
            ...
            var mjcjg = "不合格";
            var jsbeizhu = "";
            var SItems = data["S_TFS"];
            var MItem = data["M_TFS"];
            var mrsDjs = dataExtra["BZ_FS_DJT"];
            var mAllHg = true;
            ...
            var jcxm = "";
            var QBZZZD = "";
            if (!data.ContainsKey("M_TFS"))
            {
                data["M_TFS"] = new List<IDictionary<string, string>>();
            }
            if (MItem == null)
            {
            ...
            foreach (var sItem in SItems){
                ...
                if (jcxm.Contains("、拉力、")) {
                    ...
                    if (Round(HXcgfLlSUM / 5, 0) == 0 || sItem["H_PJCGFLL"] == null)
                    {
                        sItem["H_PJCGFLL"] = "----";
                    ...
                    for (int i = 1; i < 6; i++)
                    {
                        ...
                        if (GetSafeDouble(sItem["Z_CGFLL" + i]) == 0 || sItem["Z_CGFLL" + i] == null)
                        {
                            sItem["Z_CGFLL" + i] = "----";
                        }
                    }
                    sItem["Z_PJCGFLL"] = Round(ZXcgfLlSUM / 5, 0).ToString();
                    if (Round(ZXcgfLlSUM / 5, 0) == 0 || sItem["Z_PJCGFLL"] == null)
                    {
                        sItem["Z_PJCGFLL"] = "----";
                ...
                if (jcxm.Contains("、延伸率、"))
                {
                    ...
                    for (int i = 1; i < 6; i++)
                    {
                        ...
                        if (GetSafeDouble(sItem["H_DRFSCL" + i]) == 0 || sItem["H_DRFSCL" + i]==null)
                        {
                            sItem["H_DRFSCL" + i] = "----";
                        }
                    }
                    sItem["H_PJDRFSCL"] = Round(HXzdRfSclSUM / 5, 0).ToString();
                    if (Round(HXzdRfSclSUM / 5, 0) == 0 || sItem["H_PJDRFSCL"]==null)
                    { sItem["H_PJDRFSCL"] = "----"; }
                    ...
                    for (int i = 1; i < 6; i++)
                    {
                        ...
                        if (GetSafeDouble(sItem["Z_DRFSCL" + i]) == 0 || sItem["Z_DRFSCL" + i] == null)
                        {
                            sItem["Z_DRFSCL" + i] = "----";
                        }
                    }
                    sItem["Z_PJDRFSCL"] = Round(ZXzdRfSclSUM / 5, 0).ToString();
                    if (Round(ZXzdRfSclSUM / 5, 0) == 0 || sItem["Z_PJDRFSCL"] == null)
                    { sItem["Z_PJDRFSCL"] = "----"; }
