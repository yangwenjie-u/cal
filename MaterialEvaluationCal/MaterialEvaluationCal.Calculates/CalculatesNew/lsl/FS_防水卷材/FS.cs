        ...
        public void Calc()
        {
            ...
            foreach (var sItem in SItem)
            {
                ...
                if (null != mrsdj)
                {
                    ...
                    mItem["GV_SLQD"]  = mrsdj["V_SLQD"].Trim();
                    mItem["GH_SLQD"]  = mrsdj["H_SLQD"].Trim();
                    mItem["GV_KLQD"]  = mrsdj["V_KLQD"].Trim();
                    mItem["GH_KLQD"]  = mrsdj["H_KLQD"].Trim();
                    klqdJsff  = mrsdj["KLQDJSFF"].Trim();
                    klqdDw  = mrsdj["KLQDDW"].Trim();
                    mItem["GV_KLQD2"]  = mrsdj["V_KLQD2"].Trim();
                    mItem["GH_KLQD2"]  = mrsdj["H_KLQD2"].Trim();
                    mItem["GV_KLQD3"]  = mrsdj["V_KLQD3"].Trim();
                    mItem["GH_KLQD3"]  = mrsdj["H_KLQD3"].Trim();
                    mItem["GV_KLQD4"]  = mrsdj["V_KLQD4"].Trim();
                    mItem["GH_KLQD4"]  = mrsdj["H_KLQD4"].Trim();
                    mItem["G_KLSYXX"]  = mrsdj["KLSYXX"].Trim();
                    mItem["GV_SCL"]  = mrsdj["V_SCL"].Trim();
                    mItem["GH_SCL"]  = mrsdj["H_SCL"].Trim();
                    mItem["GV_SCL2"]  = mrsdj["V_SCL2"].Trim();
                    mItem["GH_SCL2"]  = mrsdj["H_SCL2"].Trim();
                    mItem["GV_SCL3"]  = mrsdj["V_SCL3"].Trim();
                    mItem["GH_SCL3"]  = mrsdj["H_SCL3"].Trim();
                    mItem["GV_SCL4"]  = mrsdj["V_SCL4"].Trim();
                    mItem["GH_SCL4"]  = mrsdj["H_SCL4"].Trim();
                    mItem["GV_CCBHL"]  = mrsdj["V_CCBHL"].Trim();
                    mItem["GH_CCBHL"]  = mrsdj["H_CCBHL"].Trim();
                    mItem["GV_CCBHL2"]  = mrsdj["V_CCBHL2"].Trim();
                    mItem["GH_CCBHL2"]  = mrsdj["H_CCBHL2"].Trim();
                    mItem["G_KRWHL"]  = mrsdj["KRWHL"].Trim();
                    mItem["G_RCLWD"]  = mrsdj["RCLWD"].Trim();
                    mItem["G_DWRD"]  = mrsdj["DWRD"].Trim();
                    mItem["G_DWWZX"]  = mrsdj["DWWZX"].Trim();
                    mItem["G_NRD"]  = mrsdj["NRD"].Trim();
                    mItem["G_KCKX"]  = mrsdj["KCKX"].Trim();
                    mItem["G_SZQTSL"]  = mrsdj["SZQTSL"].Trim();
                    mItem["G_BLX"] = mrsdj["BLX"].Trim();
                    mItem["G_LHX"] = mrsdj["LHX"].Trim();
                    mItem["G_BTSX"] = mrsdj["BTSX"].Trim();
                    mItem["G_SYX"] = mrsdj["SYX"].Trim();
                ...
                if (jcxm.Contains("、膜断裂伸长率、"))
                {
                    ...
                    if (sign)
                    {
                        ...
                        string hgmd = IsQualified(mItem["GH_MD"],sItem["GH_MD"] ,false);
