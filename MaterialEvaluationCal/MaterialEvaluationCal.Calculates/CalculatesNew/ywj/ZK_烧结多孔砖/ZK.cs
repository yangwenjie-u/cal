        ...
        public void Calc()
        {
            ...
            foreach (var sItem in SItems)
            {
                ...
                else
                {
                    ...
                    {
                        jcxmCur = CurrentJcxm(jcxm, "冻融,抗风化性能");
                    ...
                    if (sItem["QDPD"] == "合格")
                    {
                        ...
                        {
                            jcxmCur = CurrentJcxm(jcxm, "吸水率和饱和系数,抗风化性能");
                    ...
                    if (sItem["GMDPD"] == "不合格" || sItem["QDPD"] == "不合格" || sItem["WGPD"] == "不合格" || sItem["CCPD"] == "不合格" || sItem["DRPD"] == "不合格" || sItem["BHXSPD"] == "不合格" || sItem["FSPD"] == "不合格" || sItem["SHBLPD"] == "不合格" || sItem["HG_CRXS"] == "不合格")
                        mAllHg = false;
                }
            }
            #region 添加最终报告
