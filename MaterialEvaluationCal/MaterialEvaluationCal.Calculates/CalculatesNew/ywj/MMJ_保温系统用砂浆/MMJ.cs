        ...
        public void Calc()
        {
            ...
            foreach (var sItem in sItems)
            {
                ...
                else
                {
                    ...
                    if (sItem["JCBZH"].Contains("144") || sItem["JCBZH"].Contains("158") || sItem["JCBZH"].Contains("DB33/T 1054"))
                    {
                        int zs = 5;
                        ...
                        if (sItem["JCBZH"].Contains("DB33/T 1054"))
                        {
                            //抗裂砂浆 && DB33/T 1054
                            zs = 6;
                            #region 拉伸粘结原强度
                            ...
                            {
                                jcxmCur = CurrentJcxm(jcxm, "拉伸粘结原强度");
                            ...
                            {
                                jcxmCur = CurrentJcxm(jcxm, "拉伸粘结耐水强度");
                                if (MItem[0]["SFFJ"] == "复检")   //复检
                                {
                                    #region 复检 
