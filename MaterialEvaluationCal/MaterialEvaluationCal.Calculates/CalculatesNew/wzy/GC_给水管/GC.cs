        ...
        public void Calc()
        {
            ...
            foreach (var sitem in SItem)
            {
                ...
                else
                {
                    if (jcxm.Contains("、标志、"))
                    {
                        if (mhgpds >= Convert.ToInt16(MItem[0]["BZBHGS"]))
                        {
                            MItem[0]["BZ_HG"] = "合格";
                            MItem[0]["BZ"] = "符合";
                            mFlag_Hg = true;
                        ...
                        if (Convert.ToInt16(MItem[0]["BZBHGS"]) >= mbhgpds)
                        {
                            MItem[0]["BZ_HG"] = "不合格";
                            MItem[0]["BZ"] = "不符合";
                            mbhggs = mbhggs + 1;
                    ...
                    {
                        if (mhgpds >= Convert.ToInt16(MItem[0]["WGBHGS"]))
                        {
                            MItem[0]["WG_HG"] = "合格";
                            MItem[0]["WG"] = "符合";
                            mFlag_Hg = true;
                        }
                        if (Convert.ToInt16(MItem[0]["WGBHGS"]) >= mbhgpds)
                        {
                            MItem[0]["BZ_HG"] = "不合格";
                            MItem[0]["BZ"] = "不符合";
                            mbhggs = mbhggs + 1;
