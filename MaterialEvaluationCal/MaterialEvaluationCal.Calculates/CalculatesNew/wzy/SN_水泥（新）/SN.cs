                    ...
                    if (jcxm.Contains("、比表面积、"))
                    {
                        ...
                        else
                        {
                            if (Conversion.Val(sitem["MD"]) != 0)
                            {
                                ...
                                //温州
                                //第二次
                                if (Conversion.Val(sitem["MD"]) == Conversion.Val(sitem["BYMD2"]) && Conversion.Val(sitem["SYKXL2"]) == Conversion.Val(sitem["BYKXL2"]))
                                {
                                ...
                                {
                                    if (Math.Abs(Conversion.Val(sitem["SYSWD2"]) - Conversion.Val(sitem["XZSWD2"])) <= 3)
                                        mitem["XD_2"] = Round(Conversion.Val(sitem["BYBBMJ2"]) * Conversion.Val(sitem["BYMD2"]) * Math.Sqrt(Conversion.Val(sitem["SYT2"])) * (1 - Conversion.Val(sitem["BYKXL2"])) * Math.Sqrt(Conversion.Val(sitem["SYKXL2"]) * Conversion.Val(sitem["SYKXL2"]) * Conversion.Val(sitem["SYKXL2"])) / (Conversion.Val(sitem["MD"]) * Math.Sqrt(Conversion.Val(sitem["BYT2"])) * (1 - Conversion.Val(sitem["SYKXL2"])) * Math.Sqrt(Conversion.Val(sitem["BYKXL2"]) * Conversion.Val(sitem["BYKXL2"]) * Conversion.Val(sitem["BYKXL2"]))), 0).ToString();
                                    else
                                        mitem["XD_2"] = Round(Conversion.Val(sitem["BYBBMJ2"]) * Conversion.Val(sitem["BYMD2"]) * Math.Sqrt(Conversion.Val(sitem["SYT2"])) * Math.Sqrt(Conversion.Val(sitem["BYKQYD2"])) * (1 - Conversion.Val(sitem["BYKXL2"])) * Math.Sqrt(Conversion.Val(sitem["SYKXL2"]) * Conversion.Val(sitem["SYKXL2"]) * Conversion.Val(sitem["SYKXL2"])) / (Conversion.Val(sitem["MD"]) * Math.Sqrt(Conversion.Val(sitem["BYT2"])) * Math.Sqrt(Conversion.Val(sitem["SYKQYD2"])) * (1 - Conversion.Val(sitem["SYKXL2"])) * Math.Sqrt(Conversion.Val(sitem["BYKXL2"]) * Conversion.Val(sitem["BYKXL2"]) * Conversion.Val(sitem["BYKXL2"]))), 0).ToString();
                                }
                                ...
                                mitem["XD"] = (Round((Conversion.Val(mitem["XD_1"]) + Conversion.Val(mitem["XD_2"])) / 2 /10, 0) * 10).ToString();
                                if (Conversion.Val(mitem["XD_1"]) != 0 && Conversion.Val(mitem["XD_2"]) != 0)
                                {
                                    if (Math.Abs(Conversion.Val(mitem["XD_1"]) - Conversion.Val(mitem["XD_2"])) / Conversion.Val(mitem["XD_1"]) > 0.02 || Math.Abs(Conversion.Val(mitem["XD_1"]) - Conversion.Val(mitem["XD_2"])) / Conversion.Val(mitem["XD_2"]) > 0.02)
                                    {
