...
namespace Calculates
{
    public class GLJ : BaseMethods
    {
        public void Calc()
        {
            ...
            {
                MItem[0]["FJJJ1"] = " 该组试样不符合" + MItem[0]["PDBZ"] + "标准要求，需要复试。";
                mjgsm = " 该组试样不符合标准要求，需要复试。";
                if (mFlag_Bhg && mFlag_Hg)
                {
                    MItem[0]["FJJJ1"] = " 该组试样所检项目部分符合" + MItem[0]["PDBZ"] + "标准要求，需要复试。";
                    mjgsm = " 该组试样部分符合标准要求，需要复试。";
                }
            }
